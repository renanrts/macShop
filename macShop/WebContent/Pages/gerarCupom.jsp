	...
	<div class="container">
		...
		<center>
			<div class="col-md-6 p-b-30">
				<form action="/macShop/Pages/cupom" method="POST">
					<h4 class="m-text26 p-b-36 p-t-15">Gerar Cupom Promocional</h4>

					<div class="bo4 of-hidden size15 m-b-20">
						<input class="sizefull s-text7 p-l-22 p-r-22" type="number"
							name="txtValor" placeholder="Valor de desconto">
					</div>

					<div class="bo4 of-hidden size15 m-b-20">
						<input class="sizefull s-text7 p-l-22 p-r-22" type="date"
							name="txtDataVencimento" placeholder="Data de Vencimento">
					</div>
					<input type="hidden" name="txtStatus" value="Ativo"/> 
					<input type="hidden" name="txtTipo" value="PROMOCIONAL"/>
					<input type="hidden" id="FormName" name="FormName" value="VHCUPOM" />
					<div class="w-size25">
						<!-- Button -->
						<button class="btn mosh-btn mt-50" id= "btnOperacaoSalvar" name="btnOperacao" value="SALVAR">
							Enviar</button>
					</div>
				</form>
