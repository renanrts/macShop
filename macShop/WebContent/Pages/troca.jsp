...
<html>
<head>
    <title>Consulta de Trocas</title>
    <meta charset="UTF-8">
...
<body class="animsition">
    ...
    <section class="bg-title-page p-t-40 p-b-50 flex-col-c-m" style="background-image: url(../images/iphone_banner.jpg);">
        <h2 class="l-text2 t-center">
            Consulta de Solicitações de Trocas
        </h2>
    </section>
    ...
    <section class="bgwhite p-t-36 p-b-60">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="#autorizarTroca" class="confirm" data-toggle="modal"
        ...
        <div id="autorizarTroca" class="modal fade">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form>
                        <div class="modal-header">
                            <h4 class="modal-title">Autorizar troca</h4>
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        </div>
                        <div class="modal-body">
                            <p>Tem certeza que deseja autorizar a troca?</p>

                        </div>
                        <div class="modal-footer">
                            <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancelar">
                            <input type="submit" class="btn btn-info" value="Autorizar">
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div id="addEstoque" class="modal fade">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form>
                        <div class="modal-header">
                            <h4 class="modal-title">Devolução de Produto</h4>
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        </div>
                        <div class="modal-body">
                            <p>Tem certeza que deseja autorizar a troca?</p>
                        ...
                        <div class="modal-body">
                            <label><input type="checkbox" value="" class="mr-2"> Retornar produto ao estoque.</label>
                            </p>
                        </div>
