...
public class DAOAcessorio extends AbstractDAO{
	...
	public Resultado salvar(EntidadeDominio entidade) {
		...
		String sql = "INSERT INTO ACESSORIOS (acs_nome, acs_preco, cat_id, acs_datafabricacao, acs_cor, acs_dimensoes, acs_codigobarras, acs_caminhofoto, acs_descricao, acs_status, acs_modelocompativel, acs_mfi) "
				+ "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
